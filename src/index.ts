...
server.registerTool(
  "create_user",
  {
    ...
    outputSchema: {
      ...
      }).optional().describe("User's contact information"),
...
server.registerTool(
  "update_user",
  {
    ...
    outputSchema: {
      id: z.string().describe("The updated user's ID"),
      firstName: z.string().optional(),
      surname: z.string().optional(),
      contactInfo: z.object({
        email: z.string().optional(),
...
server.registerTool(
  "get_knowledge_base",
  {
    ...
    outputSchema: {
      id: z.string().describe("Knowledge base ID"),
      name: z.string().describe("Knowledge base name"),
      description: z.string().optional().describe("Knowledge base description"),
      fileCount: z.number().optional().describe("Number of files in the knowledge base"),
      agentCount: z.number().optional().describe("Number of agents using this knowledge base"),
    },
  },
...
server.registerTool(
  "create_knowledge_base",
  {
    ...
    outputSchema: {
      id: z.string().describe("The created knowledge base ID"),
      message: z.string().describe("Status message"),
    },
  },
...
server.registerTool(
  "add_file_to_knowledge_base",
  {
    ...
    outputSchema: {
      success: z.boolean(),
      message: z.string(),
      fileId: z.string().describe("The file ID that was added"),
      knowledgeBaseId: z.string().describe("The knowledge base ID"),
    },
  },
...
server.registerTool(
  "get_file",
  {
    ...
    outputSchema: {
      ...
      displayName: z.string().optional().describe("File display name"),
      ...
      metadata: z.string().optional().describe("File metadata"),
...
server.registerTool(
  "upload_file_base64",
  {
    ...
    outputSchema: {
      fileId: z.string().describe("The uploaded file's ID"),
      message: z.string().describe("Status message"),
    },
  },
...
server.registerTool(
  "embed_text",
  {
    ...
    outputSchema: {
      fileId: z.string().describe("The created file ID for the embedded text"),
      message: z.string().describe("Status message"),
    },
  },
...
server.registerTool(
  "get_file_text",
  {
    ...
    outputSchema: {
      text: z.string().describe("The extracted text content of the file"),
    },
  },
  async ({ fileId }) => {
...
server.registerTool(
  "query",
  {
    ...
    outputSchema: {
      ...
      sources: z.array(z.object({
        text: z.string().describe("Source chunk text"),
        score: z.number().optional().describe("Relevance score"),
      })).optional().describe("Matching source chunks with relevance scores"),
  ...
  async ({ input, knowledgeBaseId, fileIds, tags, includeAnswer, includeSources, includeAnalysis, model, userId }) => {
    ...
    const sources = result.embeddings?.map((emb: any) => ({
      text: emb.text,
      score: emb.score,
    })) || [];
    ...
    return {
      ...
      structuredContent: {
        answer: result.result || undefined,
        sources,
...
server.registerTool(
  "list_folders",
  {
    ...
    outputSchema: {
      ...
      })).describe("Array of folder objects"),
    },
  },
...
server.registerTool(
  "create_folder",
  {
    ...
    outputSchema: {
      id: z.string().describe("The created folder's ID"),
      message: z.string().describe("Status message"),
    },
  },
